        ...
        <fieldset>
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label for="quantiteDistribution" class="col-sm-4 control-label">Quantité de
                            distribution</label>

                        <div class="col-sm-6">
                            <input type="number" class="form-control" name="quantiteDistribution"
                                   id="quantiteDistribution"
                                   required>
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <div class="panel-footer clearfix">
                    <div class="col-md-4 col-md-offset-4">
                        ...
                        <button class="btn btn-lg btn-default col-md-6" type="submit" name="submit" id="ajout"
                                value="modif">
                            Ajouter
                        </button>
                    </div>
